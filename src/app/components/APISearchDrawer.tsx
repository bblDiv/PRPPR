    ...
    >
      ...
      >
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          {!serverUp && (
            <Alert severity="error" sx={{ mt: 1, bgcolor: "#1c1012", color: "#fca5a5" }}>
              Server is not running. Please start the backend server to use the
              API. See the backend README for setup instructions.
            </Alert>
          )}
          {!localSearchEnabled && (
            <Alert severity="warning" sx={{ mt: 1, bgcolor: "#1c1708", color: "#fde68a" }}>
        ...
        {apiSearchResults && (
          <>
            {/* Search Results Card */}
            <Card sx={{ marginTop: 2, bgcolor: "#1a1a1e", backgroundImage: "none" }}>
            ...
            {apiSearchResults &&
              ...
              Object.entries(apiSearchResults.context_data).map(
                ([key, data], index) => (
                  <Card sx={{ marginTop: 2, bgcolor: "#1a1a1e", backgroundImage: "none" }} key={index}>
                    <CardHeader
                    ...
                    >
                      <CardContent>
                        {Array.isArray(data) && data.length > 0 ? (
                          <TableContainer component={Paper} sx={{ bgcolor: "#1a1a1e", backgroundImage: "none" }}>
                            <Table size="small">
                              <TableHead>
                                <TableRow>
